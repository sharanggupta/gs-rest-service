...
[source,java]
----
include::src/main/java/dev/sharanggupta/gs_rest_service/Greeting.java[]
----
...
[source,java]
----
include::src/main/java/dev/sharanggupta/gs_rest_service/GreetingController.java[]
----
====
...
[source,java]
----
include::src/main/java/dev/sharanggupta/gs_rest_service/GsRestServiceApplication.java[]
----
====
